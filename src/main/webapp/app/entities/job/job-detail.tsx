    ...
    <Row>
      <Col md="8">
        <h2 data-cy="jobDetailsHeading">
          <Translate contentKey="comandHubApp.job.detail.title">Job</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="comandHubApp.job.task">Task</Translate>
          </dt>
          <dd>
            {jobEntity.tasks
          ...
          <dt>
            <Translate contentKey="comandHubApp.job.employee">Employee</Translate>
          </dt>
