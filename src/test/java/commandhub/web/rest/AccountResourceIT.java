...
import static commandhub.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static commandhub.test.util.OAuth2TestUtil.authenticationToken;
import static commandhub.test.util.OAuth2TestUtil.registerAuthenticationToken;
