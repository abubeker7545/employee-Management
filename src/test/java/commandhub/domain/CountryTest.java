...
import static commandhub.domain.CountryTestSamples.*;
import static commandhub.domain.LocationTestSamples.*;
import static commandhub.domain.RegionTestSamples.*;
