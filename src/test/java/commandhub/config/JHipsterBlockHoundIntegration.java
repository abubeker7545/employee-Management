...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("commandhub.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("commandhub.security.DomainUserDetailsService", "createSpringSecurityUser");
